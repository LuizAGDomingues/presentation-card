        ...
        <ul className='mt-12 list-none p-0 flex gap-2 justify-center'>
          <li>
            <a href="https://facebook.com/luiz.domingues.509" target="_blank">
              <img src="../../images/facebook.svg" alt="ícone facebook" className='rounded hover:border-2 border-purple-300'/>
            </a>
          </li>
          <li>
            <a href="https://twitter.com/Luiz_gDomingues" target="_blank">
              <img src="../../images/twitter.svg" alt="icone twitter" className='rounded hover:border-2 border-purple-300'/>
            </a>
          </li>
          <li>
            <a href="https://instagram.com/luiz_gdomingues/" target="_blank">
              <img src="../../images/instagram.svg" alt="icone instagram" className='rounded hover:border-2 border-purple-300'/>
            </a>
          </li>
        </ul>
        <nav className="mt-16 ml-28 w-40 rounded md:ml-28 md:m-3 hover:border-2 border-purple-300">
          <Link to='/AboutLuiz'>Conheça mais</Link>
        </nav>
      </div>
    )
}